...
const AllToys = ({setTitle}) => {
    ...
    return (
        <>{loading?<Spinner/>: <section className='flex flex-col items-center justify-center mt-20 space-y-8'>
        ...
        <button className='hover:opacity-[90%] btn bg-gradient-to-r from-blue-800 via-blue-700 to-purple-700 w-fit mx-auto' >See More</button>
